...
func NewUserServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) UserServiceClient {
	...
	userServiceMethods := app.File_app_user_service_proto.Services().ByName("UserService").Methods()
	return &userServiceClient{
		createUser: connect.NewClient[app.User, app.User](
			httpClient,
...
func (c *userServiceClient) CreateUser(ctx context.Context, req *connect.Request[app.User]) (*connect.Response[app.User], error) {
