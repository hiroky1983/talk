...
import (
	...
	context "context"
	errors "errors"
	v1 "github.com/myuser/myproject/gen/app/v1"
	http "net/http"
	strings "strings"
)
...
const (
	...
	SampleServiceName = "app.v1.SampleService"
)
...
const (
	...
	SampleServiceGetSampleProcedure = "/app.v1.SampleService/GetSample"
)
...
func NewSampleServiceHandler(svc SampleServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/app.v1.SampleService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
