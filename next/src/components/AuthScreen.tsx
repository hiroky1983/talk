    ...
    <div className="min-h-screen bg-gradient-to-br from-indigo-100 via-purple-50 to-pink-100 dark:from-indigo-950 dark:via-gray-900 dark:to-pink-950 flex items-center justify-center p-4 relative overflow-hidden">
      ...
      <div className="bg-white/80 dark:bg-gray-900/80 backdrop-blur-xl border border-white/50 dark:border-gray-700/50 rounded-2xl shadow-2xl p-8 w-full max-w-md relative z-10 transition-all duration-300 hover:shadow-3xl">
        <div className="text-center mb-8">
          ...
          <p className="text-gray-600 dark:text-gray-300 font-medium">{tCommon('tagline')}</p>
        </div>
        ...
        <div className="space-y-6">
          ...
          <div>
            ...
            <div className="relative">
              <select
                ...
                className="w-full p-4 pl-5 pr-10 bg-white/50 dark:bg-gray-800/50 border border-gray-200 dark:border-gray-700 rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-500/50 dark:focus:ring-blue-400/50 focus:border-blue-500 dark:focus:border-blue-400 transition-all duration-200 text-gray-800 dark:text-gray-100 appearance-none shadow-sm cursor-pointer hover:border-blue-300 dark:hover:border-blue-600"
              >
          ...
          <div className="pt-2">
            ...
            {/* Error Message Area */}
            {error && (
              <div className="mt-4 p-3 bg-red-50 dark:bg-red-900/40 border border-red-100 dark:border-red-800 rounded-lg text-red-600 dark:text-red-300 text-sm flex items-center animate-fadeIn">
                <svg
